...
stopwords_list = [
    ...
    "autrement", "autres", "autrui", "aux", "auxquelles", "auxquels", "avaient",
    "avais", "avait", "avant", "avec", "avoir", "avons", "ayant", "b", "bah",
    "bas", "basee", "bat", "beau", "beaucoup", "bien", "bigre", "boum", "bravo",
    ...
    "fi", "flac", "floc", "font", "g", "gens", "h", "ha", "hein", "hem", "hep",
    ...
    "toutes", "treize", "trente", "tres", "trois", "troisième", "troisièmement",
